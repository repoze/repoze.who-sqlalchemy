# -*- coding: utf-8 -*-
#
# repoze.who SA documentation build configuration file, created by
...
project = u'repoze.who SQLAlchemy plugin'
...
htmlhelp_basename = 'repozewhosadoc'
...
latex_documents = [
  ('index', 'repozewhopluginssa.tex', u'repoze.who SA Documentation',
